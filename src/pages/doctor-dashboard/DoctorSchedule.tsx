          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="w-full">
                ...
                <div className="space-y-6">
                    ...
                    {/* Schedule List */}
                    <div className="bg-white rounded-2xl shadow-sm border border-slate-100 overflow-hidden min-h-96">
                                                ...
                                                {appointment ? (
                                                  // Existing appointment logic
                                                    <div className={`p-4 rounded-xl border-l-4 ${
                                                     ...
                                                     <div className="h-full min-h-16 rounded-xl border-2 border-dashed border-transparent group-hover:border-slate-200 flex items-center justify-start px-4 transition-colors">
                                                        <span className="text-slate-400 text-sm font-medium opacity-0 group-hover:opacity-100 transition-opacity flex items-center gap-2">
