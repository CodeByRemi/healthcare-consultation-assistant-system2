                        ...
                        >
                            ...
                            <div className="space-y-3 mb-6">
                                <div className="flex items-center gap-2 text-slate-500 text-sm">
                                    ...
                                    <span className="truncate">{doc.location || "Location"}</span>
                                </div>
                                <div className="flex items-center gap-2 text-slate-500 text-sm">
                                    <FaUserMd className="text-slate-400 min-w-4" />
                                    {doc.experience ? `${doc.experience} Experience` : "Experience"}
                                </div>
                                <div className="flex items-center gap-2 text-slate-500 text-sm">
                                    <FaCalendarAlt className="text-slate-400 min-w-4" />
                                    <span className="truncate">
                                        {doc.availableDays && doc.availableDays.length > 0 ? doc.availableDays.slice(0, 3).join(", ") + (doc.availableDays.length > 3 ? "..." : "") : "Available Days"}
                                    </span>
                                </div>
                            </div>
                                            ...
                                            <div>
                                                ...
                                                <div className="flex items-center gap-4 flex-wrap">
                                                    <div className="flex items-center gap-2 text-slate-600">
                                                        ...
                                                        <span className="text-sm">{selectedDoctor.experience ? `${selectedDoctor.experience} Years Experience` : "Experience"}</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div className="lg:col-span-2 space-y-8">
                                        ...
                                        <div className="bg-slate-50 p-6 rounded-2xl border border-slate-200">
                                            ...
                                            <div className="space-y-3">
                                                <div className="flex items-start gap-3">
                                                    ...
                                                    <p className="text-slate-600">{selectedDoctor.education || "Education"}</p>
                                                </div>
                                                <div className="flex items-start gap-3">
                                                    <div className="w-2 h-2 rounded-full bg-[#0A6ED1] mt-2 shrink-0"></div>
                                                    <p className="text-slate-600">{selectedDoctor.certification || "Certification"}</p>
                                                </div>
                                                <div className="flex items-start gap-3">
                                                    <div className="w-2 h-2 rounded-full bg-[#0A6ED1] mt-2 shrink-0"></div>
                                                    <p className="text-slate-600">{selectedDoctor.specialization || "Specialization"}</p>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                            <div className="bg-slate-50 p-6 rounded-2xl border border-slate-200">
                                                ...
                                                <p className="text-slate-600 text-sm">{selectedDoctor.location || "Location"}</p>
                                            </div>
