...
content = content.replace(`  return (
    <div className="min-h-screen bg-slate-50 flex flex-col md:flex-row font-['Manrope']">`, earlyReturnStr);

fs.writeFileSync(file, content);
console.log("Hooks order fixed cleanly.");
